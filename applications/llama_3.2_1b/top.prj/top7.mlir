module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_10(%tile_1_2, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    aie.objectfifo @fifo_12(%tile_1_3, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    aie.objectfifo @fifo_13(%mem_tile_2_1 dimensionsToStream [<size = 16, stride = 256>, <size = 4, stride = 4>, <size = 16, stride = 16>, <size = 4, stride = 1>], {%shim_noc_tile_1_0}, 2 : i32) : !aie.objectfifo<memref<1x1x64x64xbf16>> 
    aie.objectfifo @fifo_16(%tile_1_5, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    aie.objectfifo @fifo_17(%mem_tile_0_1 dimensionsToStream [<size = 16, stride = 256>, <size = 4, stride = 4>, <size = 16, stride = 16>, <size = 4, stride = 1>], {%shim_noc_tile_3_0}, 2 : i32) : !aie.objectfifo<memref<1x1x64x64xbf16>> 
    ...
    %core_1_3 = aie.core(%tile_1_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %2 = aie.objectfifo.acquire @fifo_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        func.call @matmul_bf16_bf16(%3, %buffer_1_3, %1) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
        aie.objectfifo.release @fifo_0(Consume, 1)
    ...
    %core_1_5 = aie.core(%tile_1_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %2 = aie.objectfifo.acquire @fifo_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        func.call @matmul_bf16_bf16(%3, %buffer_1_5, %1) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
        aie.objectfifo.release @fifo_0(Consume, 1)
    ...
    aiex.runtime_sequence(%arg0: memref<4096xbf16>, %arg1: memref<262144xbf16>) {
      ...
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 128][8, 1, 64, 64][512, 64, 4096, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_7} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 192][8, 1, 64, 64][512, 64, 4096, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_9} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 256][8, 1, 64, 64][512, 64, 4096, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_11} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 320][8, 1, 64, 64][512, 64, 4096, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_13} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 448][8, 1, 64, 64][512, 64, 4096, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_17} : memref<262144xbf16>
